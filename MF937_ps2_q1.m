...
cd '/home/moralesmendozar/Dropbox/03_UPenn/classes/2019_fall/01_937-/PS02'
...
fprintf('Average Default Probability is %2.8f\n', defaultProbability);
...
%% (3) leverage ratio, b/k;
leverageRatioo = sum(sum(sum(sum(mBond4D ./ mK4D   .*distributionStationary0))));
leverageRatio = leverageRatioo;
...
% 
%             0             1.01010101010101    0.539685131401485     2.00309383800015          0.0302962794853071     
